def load_parameters():
    ...
    if CLASSIFICATION_TYPE == 'single-label':
        ...
        IMG_FILES = {'train': 'Annotations/train.txt',  # Image and features files
                     'val': 'Annotations/val.txt',
                     'test': 'Annotations/test.txt'
                    }
        LABELS_FILES = {'train': 'Annotations/train_labels.txt',  # Question files
        ...
        IMG_FILES = {'train': 'Annotations/train_split.txt',  # Image and features files
    ...
    elif NETWORK_TYPE == 'VGG16' or NETWORK_TYPE == 'TestModel':
    ...
    EXTRA_NAME = 'inception_recipes_v2' # custom name assigned to the model
